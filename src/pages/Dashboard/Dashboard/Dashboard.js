...
function Dashboard(props) {
    ...
    const drawer = (
        <div>
            <Toolbar />
            <Divider />
            <Link style={{ textDecoration: 'none' }} to="/moreProducts"><Button color="inherit">More Products</Button></Link>
            <br />


            {!admin && <Box>
                <Link style={{ textDecoration: 'none' }}
                    to={`${url}/addReview`}><Button color="inherit">Add Review</Button></Link>
                <br />
